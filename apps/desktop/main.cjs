...
<p style="color:%2394a3b8;font-size:.9rem">brain &middot; connectors &middot; knowledge (encrypted)</p>
<p style="color:%23475569;font-size:.8rem;margin:.4rem 0 0">version ${app.getVersion()}</p></body>`
