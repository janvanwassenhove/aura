...
The working-agreement block below is shared verbatim with
[`CLAUDE.md`](CLAUDE.md) and
[`.github/copilot-instructions.md`](.github/copilot-instructions.md), because
three tools read three different filenames and a rule only one of them can see
is not a rule. Edit [`docs/agent-working-agreement.md`](docs/agent-working-agreement.md)
and run `python scripts/sync_agent_docs.py`; CI fails if the copies drift.  
